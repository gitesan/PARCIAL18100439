...
namespace PARCIAL18100439.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class MechanicController : ControllerBase
    {
        private readonly Parcial202418100439DbContext _context;

        public MechanicController(Parcial202418100439DbContext context)
        {
            _context = context;
        }
